...
public class JanelaDadosTecnico extends JFrame
{
	...
	public JanelaDadosTecnico (Tecnico tecnico)
	{
		...
		conteudo.add( new JLabel("Tecnico ID: #" + tecnico.getMatricula()));
		...
		confirma = new JButton ("Cliente");
		confirma.addActionListener(new BotaoCliente(this));
		botoes.add(confirma);
		
		volta = new JButton ("Tecnico");
		volta.addActionListener(new BotaoTecnico(this));
		botoes.add(volta);
